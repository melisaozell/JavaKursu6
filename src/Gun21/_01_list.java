...
public class _01_list
{
    public static void main(String[] args) {
        ...
        isimler.add("Ahmet");//uzunluk1
        isimler.add("Metin");//2
        isimler.add("Burak");//3
        isimler.add("Cansu");//4 //sona ekler

        System.out.println("isimler1 = " + isimler);//yazdırır
        System.out.println("isimler.size() = " + isimler.size());//uzunluğu verir

        isimler.add(1,"Nurhayat");//verilen indexe ekliyor,diğerleri 1 kayıyor sona doğru
